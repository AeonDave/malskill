...
For tty_struct kROP (kernel Return-Oriented Programming), userfaultfd race stabilization, SLUB internals, cross-cache attacks, and kernel patterns, see [kernel-techniques.md](kernel-techniques.md).
