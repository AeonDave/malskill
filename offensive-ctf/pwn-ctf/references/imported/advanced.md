...
**Pattern:** Off-by-one in instruction encoding causes misaligned machine code.
...
**Pattern:** Brainfuck/Pikalang interpreter with unbounded tape allows arbitrary memory access.
...
**Pattern:** Number stored as string in different bases has different lengths.
...
**Pattern:** Imbalanced binary tree causes stack buffer underallocation.
...
**Exploitation:** Craft tree structure that causes traversal to overflow buffer → overwrite return address → ret2win.
