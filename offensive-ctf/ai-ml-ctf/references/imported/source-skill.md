...
Quick reference for AI/ML challenges. Each technique has a one-liner here; see supporting files for full details.
...
- **Membership inference:** Determining whether a specific sample was in the training data based on score distribution. See [model-attacks.md](model-attacks.md#membership-inference-attack).
