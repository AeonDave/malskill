...
- [LD_PRELOAD Hook via rbash-Allowed Variable Set]
- [/dev/tcp Exfiltration from Minimal Command Set]
- [Layer-by-Layer Echo-Only Bash Escape]
- [Closed-Stdout Jail with \r Truncation]
...
**Pattern:** Filter regex `^[\\#\$]+$` allows only hash, dollar, backslash.
...
- public source CTF "HashCashSlash": Filter `^[\\#\$]+$`, payload `\$$#`, internal socat flag service
