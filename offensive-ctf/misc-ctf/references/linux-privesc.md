# Preserved source: linux-privesc.md
...
- [SSH Unix Socket Tunneling]
- [NFS Share Exploitation for Sensitive Data]
- [PaperCut Print Deploy Privilege Escalation]
- [Squid Proxy Pivoting to Internal Services]
- [Zabbix Admin Password Reset via MySQL]
- [WinSSHTerm Encrypted Credential Decryption]
- [sudo file -m Magic File Directory Traversal]
- [CVE-2018-19788 — polkit UID Integer Overflow → Systemd RCE]
- [Sudo Glob Path + Symlink Confused Deputy via vim]
- [TOCTOU Symlink Swap Race on FileChecker]
...
while true; do./FileChecker link 2>/dev/null | grep -m1 'MCA{' && break
done
```
