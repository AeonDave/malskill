...
Use this reference when the concise `SKILL.md` routing is not enough and the agent needs a step-by-step solve loop for reverse-engineering challenge solving.
...
3. **Technique handoff** — load the first matching methodology skill: `reversing-technique`, `crypto-technique`, `forensic-technique`.
4. **Tool selection** — choose from: `offensive-tools/rev/ghidra`, `offensive-tools/rev/radare2`, `offensive-tools/rev/binaryninja`, `offensive-tools/rev/gdb`, `offensive-tools/rev/x64dbg`, `offensive-tools/rev/frida`, `offensive-tools/rev/dnspy`, `offensive-tools/forensic/capa`.
