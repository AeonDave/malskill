# CTF Reverse - Anti-Analysis Detection and Evasion

Focused anti-analysis reference for detection surfaces and direct bypasses: anti-debug, anti-VM, anti-DBI, and code-integrity checks.
