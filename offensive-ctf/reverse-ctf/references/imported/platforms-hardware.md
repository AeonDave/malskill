# Preserved source: platforms-hardware.md
...
AArch64 (ARM 64-bit) appears in mobile apps, cloud servers (AWS Graviton), Apple Silicon, and challenges. Key differences from x86-64 affect both reversing and exploitation.
