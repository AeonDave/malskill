...
- [.NET Analysis](#net-analysis)
  - [Tools](#tools)
  - [Two-Stage XOR + AES-CBC Decode Pattern]
  - [NativeAOT](#nativeaot)
...
- [boolector SMT2 for Custom Hash Reversal]
...
**Pattern:** Statically linked, stripped RISC-V ELF binary. Can't run natively on x86.
...
(assert (bvule input #x000000007e7e7e7e)); printable upper bound; Emit the hash function as bvxor/bvrol/bvadd chains
