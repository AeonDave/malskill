...
- Upstream methodology: `offensive-techniques/binary-exploitation-technique` (when to choose ROP vs data-only, chain staging) and `offensive-ctf/pwn-ctf/references/rop.md` (concrete chain recipes).
