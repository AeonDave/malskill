...
**Skill routing**: route by objective/capability before broad search. Prefer best-fit triage or methodology skill for unknown targets, attack-path work, and tradecraft; best-fit capability-development skill for code/evasion/implant/exploit work; best-fit lab/challenge-solving skill for flag or offline puzzle work; tool skills only after method chosen or when user names tool. Common naming conventions are useful hints, not hard requirements. One primary skill + 1-2 support refs max. If exploit construction or lab/challenge solve stays blocked after evidence-based pivots, add narrowest available hint/research support skill as targeted post-triage support.
